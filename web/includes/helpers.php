...
function conseguirCategorias($conexion, $limit = NULL){
...
function conseguirCategoria($conexion, $id){
	$sql = "SELECT * FROM categorias WHERE id = $id ORDER BY nombre ASC";
        //die($sql);
	$categorias = mysqli_query($conexion, $sql);
...
function conseguirTodasLasEntradas($conexion){
	$sql = "SELECT e.*, c.nombre AS 'categoria' FROM entradas e ".
               "INNER JOIN categorias c ON e.categoria_id = c.id ORDER BY e.id DESC";
